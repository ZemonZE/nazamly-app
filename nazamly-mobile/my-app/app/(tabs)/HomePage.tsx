    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsRow}>
          <StatCard icon="book-open" label="Courses" value="5" color="#3b82f6" />
          <StatCard icon="calendar" label="Today" value="2" color="#8b5cf6" />
          <StatCard icon="help-circle" label="Questions" value="8" color="#f59e0b" />
        </View>
...
const styles = StyleSheet.create({
  ...
  scheduleHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 },
