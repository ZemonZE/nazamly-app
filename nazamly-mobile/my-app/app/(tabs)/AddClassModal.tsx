            ...
            <View style={styles.overlay}>
                ...
                >
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput style={styles.input} placeholder="e.g. Data Structures" placeholderTextColor="#94a3b8" />
                    </View>

                    <View style={styles.inputGroup}>
                        <Text style={styles.label}>Course Code</Text>
                        <TextInput style={styles.input} placeholder="e.g. CS201" placeholderTextColor="#94a3b8" />
                    </View>
                    ...
                    <View style={styles.row}>
                        <View style={[styles.inputGroup, { flex: 1, marginRight: 10 }]}>
                            ...
                            <TextInput style={styles.input} placeholder="08 : 00 AM" placeholderTextColor="#94a3b8" />
                        </View>
                        <View style={[styles.inputGroup, { flex: 1, marginLeft: 10 }]}>
                            <Text style={styles.label}>End Time *</Text>
                            <TextInput style={styles.input} placeholder="09 : 30 AM" placeholderTextColor="#94a3b8" />
                        </View>
                    </View>

                    <View style={styles.inputGroup}>
                        <Text style={styles.label}>Room / Location</Text>
                        <TextInput style={styles.input} placeholder="e.g. B204" placeholderTextColor="#94a3b8" />
                    </View>
