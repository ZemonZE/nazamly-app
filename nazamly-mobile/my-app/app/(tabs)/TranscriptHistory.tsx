...
export default function TranscriptHistoryScreen() {
  ...
  const [confirmItem, setConfirmItem] = useState<TranscriptHistoryItem | null>(
    null,
  );
      ...
      >
        <View style={s.modalOverlay}>
          <View style={[s.modalBox, { backgroundColor: colors.card }]}>
            <View
              style={[s.modalIconWrap, { backgroundColor: colors.red + "15" }]}
            >
      ...
      >
        ...
        {loading ? (
          ...
          <View style={s.emptyWrap}>
            ...
            <View
              style={[s.blob1, { backgroundColor: colors.indigo + "18" }]}
            />
            ...
            <View
              style={[
                s.emptyIconRing,
                {
                  borderColor: colors.indigoLight + "40",
            ...
            <Text style={[s.emptySub, { color: colors.textMuted }]}>
              Upload your academic transcript and let AI extract your grades
              automatically
            </Text>
          ...
          history.map((item) => (
            ...
            >
              <View style={s.cardLeft}>
                <View
                  style={[s.fileIcon, { backgroundColor: colors.indigoPale }]}
                >
                  <Feather name="file-text" size={20} color={colors.indigo} />
                </View>
                <View style={s.cardInfo}>
                  <Text
                    style={[s.fileName, { color: colors.textPrimary }]}
                    numberOfLines={1}
                  >
                    {item.fileName}
                  </Text>
                  <Text style={[s.fileDate, { color: colors.textMuted }]}>
                  ...
                  <View style={s.metaRow}>
                    ...
                    {item.status === "completed" && (
                      <Text
                        style={[s.gpaText, { color: colors.textSecondary }]}
                      >
